        ...
        <div class="relative flex flex-row" x-data="{ open: false }" @click.away="open = false">
            ...
            <div class="relative flex flex-row" x-data="{ open: false }" @click.away="open = false">
              ...
              <div class="bg-blue dropdown-menu absolute top-full mt-2 z-10 text-left px-[1.15rem] whitespace-nowrap" :class="{ 'scale-100': open, 'scale-0': !open }" x-show="open" id="dropdownMenu">
                  ...
                  <div @click="navigate('{{ route('login') }}')" class="dropdown-menu-item hover:text-gold duration-150">Job Posting</div>
              </div>
          </div>
        <div class="relative flex flex-row" x-data="{ open: false }" @click.away="open = false">
                <a href="#" onclick="window.location.href='/resources/views/services.html'" class ="hover:text-gold">
...
<div class="h-screen w-screen flex flex-col">
    ...
    <!-- LOGIN BUTTON-->
     <div class="w-full pt-36 flex justify-center">
     <button onclick="window.location.href='{{ route('login') }}'" class=" hover:bg-blue-hover duration-150 hover:border-blue-hover font-inter text-center text-10 whitespace-nowrap text-white-10 py-4 my-5 px-8 bg-blue rounded border-[1px] border-blue">
        LOGIN TO ACCESS
    </button>
    </div>
 ...
 <div class="flex flex-col bg-white-10 drop-shadow-[0px_0px_3px_rgba(0,0,0,0.3)]">
    ...
    <!--Footer-->
    <div class="-mt-6 w-screen h-screen relative">
        ...
        <div class="absolute justify-center flex flex-row items-center inline-flex">
            ...
            <div class="flex flex-row pt-[7rem] pl-[35rem] ml-[19rem] w-3/4 flex flex-col">
